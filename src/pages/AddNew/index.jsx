  ...
  return (
    <div className="fade-in form-container">
      <div className="flex items-start gap-4 mb-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-slate-800 tracking-tight">Create New Article</h2>
          <p className="text-sm text-slate-500 font-medium">Draft your masterpiece and share it with the world.</p>
        </div>
      </div>
